...
(custom-set-variables
 ...
 '(package-selected-packages
   '(cider clojure-mode slime-company treemacs-magit treemacs-icons-dired treemacs-projectile treemacs-evil treemacs slime org-bullets helm-ag web-mode lsp-mode company flycheck evil-collection evil-magit magit projectile rainbow-delimiters helm nav-flash which-key sexy-monochrome-theme evil use-package)))
(custom-set-faces
